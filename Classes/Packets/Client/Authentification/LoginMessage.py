...
class LoginMessage(PiranhaMessage):
    ...
    def execute(message, calling_instance, fields):
        ...
        if fields["ClientMajor"] == 43:
            ...
            elif Configuration.settings["Maintance"] == True:
            	Messaging.sendMessage(20103, {'Socket': calling_instance.client, 'ErrorID': 10, 'Message': None, 'FingerprintData': None, 'ContentURL': None}) # Maintance
            
            elif banned == True:
            	Messaging.sendMessage(20103, {'Socket': calling_instance.client, 'ErrorID': 11, 'Message': "Your banned", 'FingerprintData': None, 'ContentURL': None}) # Ban
            
            elif fields["ClientMajor"] < 43:
            	Messaging.sendMessage(20103, {'Socket': calling_instance.client, 'ErrorID': 8, 'Message': "FightingBrawl Update Available!", 'FingerprintData': None, 'ContentURL': None}) # Update
