...
from Classes.Packets.Client.Battle.SinglePlayerMatchRequestMessage import SinglePlayerMatchRequestMessage
...
from Classes.Packets.Server.Alliance.AllianceLeagueDataMessage import AllianceLeagueDataMessage
from Classes.Packets.Server.Alliance.AllianceStreamEntryMessage import AllianceStreamEntryMessage
from Classes.Packets.Client.Alliance.ChatToAllianceStreamMessage import ChatToAllianceStreamMessage
from Classes.Packets.Client.Alliance.AskForAllianceLeagueLeaderboardMessage import AskForAllianceLeagueLeaderboardMessage
from Classes.Packets.Server.Alliance.AllianceLeagueLeaderboardMessage import AllianceLeagueLeaderboardMessage
...
from Classes.Packets.Client.Home.GetBattleLogMessage import GetBattleLogMessage
...
from Classes.Packets.Client.Event.ChronosEventSeenMessage import ChronosEventSeenMessage
...
from Classes.Packets.Client.Team.TeamMemberStatusMessage import TeamMemberStatusMessage
from Classes.Packets.Server.Home.PlayerStatusMessage import PlayerStatusMessage
from Classes.Packets.Server.Team.TeamLeftMessage import TeamLeftMessage
from Classes.Packets.Server.Team.TeamStreamMessage import TeamStreamMessage
#from Classes.Packets.Server.Team.TeamToggleSettingsMessage import TeamToggleSettingsMessage
from Classes.Packets.Server.Team.TeamErrorMessage import TeamErrorMessage
...
from Classes.Packets.Client.Friend.AskForAddableFriendsMessage import AskForAddableFriendsMessage
from Classes.Packets.Server.Friend.AddableFriendsMessage import AddableFriendsMessage

# Latency
from Classes.Packets.Server.Latency.LatencyTestResultMessage import LatencyTestResultMessage
from Classes.Packets.Server.Latency.TriggerStartLatencyTestMessage import TriggerStartLatencyTestMessage
from Classes.Packets.Server.Latency.UdpLatencyTestRequestMessage import UdpLatencyTestRequestMessage
from Classes.Packets.Server.Latency.RequestLatencyTestStatusMessage import RequestLatencyTestStatusMessage

from Classes.Packets.Client.Event.AnalyticEventMessage import AnalyticEventMessage
from Classes.Packets.Client.Event.ClientCapabilitiesMessage import ClientCapabilitiesMessage
...
class LogicLaserMessageFactory:
    messagesList = {
        ...
        12160: AskForAllianceLeagueLeaderboardMessage,
        ...
        22160: AllianceLeagueLeaderboardMessage,
        22161: AllianceLeagueDataMessage,
