...
class DatabaseHandler():
    ...
    def loadAccount(self, player, plrId):
        try:
            ...
            player.CoinsGained = playerData["CoinsGained"]
            ...
            player.TrophiesGained = playerData["TrophiesGained"]
            player.TrophyRoadTier = playerData["TrophyRoadTier"]
            player.Experience = playerData["Experience"]
            player.Level = playerData["Level"]
            player.Tokens = playerData["Tokens"]
            player.TokensGained = playerData["TokensGained"]
            player.TokensDoubler = playerData["TokensDoubler"]
            player.PushasedOffers = playerData["PushasedOffers"]
            player.delivery_items = playerData["delivery_items"]
            player.BattleLogs = playerData["BattleLogs"]
